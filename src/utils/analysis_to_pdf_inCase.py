...
# my_df[['War Name','War Years']] = my_df['War Name'].str.split('(', expand=True)

# # Remove bracket and spaces from 'War Years' column
# my_df[['War Name', 'War Years']] = my_df[['War Name', 'War Years']].applymap(lambda item: item.replace(')', '').rstrip())
...
# plot_image_path = r'src\static\images\plot_image.png'
...
# pdf_output_path = r'src\static\pdf\output.pdf'
