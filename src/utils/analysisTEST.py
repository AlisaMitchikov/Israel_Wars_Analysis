...
pdf_filename = r"E:\קריירה\הכנה 2024\פרוייקטים\analysis\app\test.pdf"
with PdfPages(pdf_filename) as pdf: 
    ...
    plt.title('Count wars per results - bar')
    ...
    plt.title('Count wars per results - pie chart')
    pdf.savefig()  # Save this plot to PDF
    plt.close()
...
# # --------------------------------------
    ...
    plt.title('Losses by wars - Civilians')
    pdf.savefig()  # Save this plot to PDF
    plt.close()
    ...
    plt.title('Losses by wars - General')
    pdf.savefig()  # Save this plot to PDF
    plt.close()
...
# # --------------------------------------
    ...
    plt.title('Wars per Prime Minister')
    pdf.savefig()  # Save this plot to PDF
    plt.close()    
    ...
    plt.title('Wars through the years')
    pdf.savefig()  # Save this plot to PDF
    plt.close()
